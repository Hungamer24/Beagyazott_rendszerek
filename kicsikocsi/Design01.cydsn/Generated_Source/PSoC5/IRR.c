...
*
* \funcusage
*  \snippet IRR_SUT.c usage_IRR_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet IRR_SUT.c usage_IRR_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet IRR_SUT.c usage_IRR_Read  
*******************************************************************************/
uint8 IRR_Read(void)
{
...
* preferred IRR_Read() API because the 
* IRR_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet IRR_SUT.c usage_IRR_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: IRR_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use IRR_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - IRR_0_INTR       (First pin in the list)
    *  - IRR_1_INTR       (Second pin in the list)
    *  - ...
    *  - IRR_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet IRR_SUT.c usage_IRR_SetInterruptMode
    *******************************************************************************/
    void IRR_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & IRR_0_INTR) != 0u) 
		{ 
			 IRR_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet IRR_SUT.c usage_IRR_ClearInterrupt
    *******************************************************************************/
