...
**************************************/
#define Right_Motor_INIT_PERIOD_VALUE          (255u)
...
#define Right_Motor_DEFAULT_COMPARE1_MODE      (uint8)((uint8)2u <<  Right_Motor_CTRL_CMPMODE1_SHIFT)
