...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=141, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=true, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Left_Motor_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Left_Motor_PWM, CY_INSTANCE_SHORT_NAME=Left_Motor_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Left_Motor_PWM, )
module PWM_v3_30_1 (
    reset,
    clock,
    tc,
...
module ADC_SAR_v3_10_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("4d6d5d9d-b1d0-47fa-abf0-1ce990cd8705/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module CharLCD_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("de1c9b79-05c8-491b-be7f-ed6b0f3c95dc/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    PWM_v3_30_0 Right_Motor_PWM (
        ...
        .ph1(Net_116),
        .ph2(Net_117));
    defparam Right_Motor_PWM.Resolution = 8;

	wire [0:0] tmpOE__IRL_net;
	wire [0:0] tmpFB_0__IRL_net;
	wire [0:0] tmpIO_0__IRL_net;
	wire [0:0] tmpINTERRUPT_0__IRL_net;
	electrical [0:0] tmpSIOVREF__IRL_net;
	...
	cy_psoc3_pins_v1_10
		...
		IRL
		 (.oe(tmpOE__IRL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IRL_net[0:0]}),
		  .io({tmpIO_0__IRL_net[0:0]}),
		  .siovref(tmpSIOVREF__IRL_net),
		  .interrupt({tmpINTERRUPT_0__IRL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IRL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Right_Motor_DIR_net;
	wire [0:0] tmpFB_0__Right_Motor_DIR_net;
	wire [0:0] tmpIO_0__Right_Motor_DIR_net;
	wire [0:0] tmpINTERRUPT_0__Right_Motor_DIR_net;
	electrical [0:0] tmpSIOVREF__Right_Motor_DIR_net;

	cy_psoc3_pins_v1_10
		#(.id("07705fec-899a-4c61-88af-136a48c545ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Right_Motor_DIR
		 (.oe(tmpOE__Right_Motor_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Right_Motor_DIR_net[0:0]}),
		  .io({tmpIO_0__Right_Motor_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_Motor_DIR_net),
		  .interrupt({tmpINTERRUPT_0__Right_Motor_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_Motor_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Reg_PWM_Enable (
        .control_1(Net_418),
        .control_2(Net_534),
        .control_3(Net_535),
        .control_0(Net_543),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Reg_PWM_Enable.Bit0Mode = 0;
    defparam Reg_PWM_Enable.Bit1Mode = 0;
    defparam Reg_PWM_Enable.Bit2Mode = 0;
    defparam Reg_PWM_Enable.Bit3Mode = 0;
    defparam Reg_PWM_Enable.Bit4Mode = 0;
    defparam Reg_PWM_Enable.Bit5Mode = 0;
    defparam Reg_PWM_Enable.Bit6Mode = 0;
    defparam Reg_PWM_Enable.Bit7Mode = 0;
    defparam Reg_PWM_Enable.BitValue = 0;
    defparam Reg_PWM_Enable.BusDisplay = 0;
    defparam Reg_PWM_Enable.ExtrReset = 0;
    defparam Reg_PWM_Enable.NumOutputs = 2;

	wire [0:0] tmpOE__IRR_net;
	wire [0:0] tmpFB_0__IRR_net;
	wire [0:0] tmpIO_0__IRR_net;
	wire [0:0] tmpINTERRUPT_0__IRR_net;
	electrical [0:0] tmpSIOVREF__IRR_net;

	cy_psoc3_pins_v1_10
		#(.id("4ea2e565-3ca3-4fc8-8c20-6142e1c765a3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		IRR
		 (.oe(tmpOE__IRR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IRR_net[0:0]}),
		  .io({tmpIO_0__IRR_net[0:0]}),
		  .siovref(tmpSIOVREF__IRR_net),
		  .interrupt({tmpINTERRUPT_0__IRR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IRR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Left_Motor_DIR_net;
	wire [0:0] tmpFB_0__Left_Motor_DIR_net;
	wire [0:0] tmpIO_0__Left_Motor_DIR_net;
	wire [0:0] tmpINTERRUPT_0__Left_Motor_DIR_net;
	electrical [0:0] tmpSIOVREF__Left_Motor_DIR_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Left_Motor_DIR
		 (.oe(tmpOE__Left_Motor_DIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Left_Motor_DIR_net[0:0]}),
		  .io({tmpIO_0__Left_Motor_DIR_net[0:0]}),
		  .siovref(tmpSIOVREF__Left_Motor_DIR_net),
		  .interrupt({tmpINTERRUPT_0__Left_Motor_DIR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Left_Motor_DIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Left_Motor_Control_net;
	wire [0:0] tmpFB_0__Left_Motor_Control_net;
	wire [0:0] tmpIO_0__Left_Motor_Control_net;
	wire [0:0] tmpINTERRUPT_0__Left_Motor_Control_net;
	electrical [0:0] tmpSIOVREF__Left_Motor_Control_net;

	cy_psoc3_pins_v1_10
		#(.id("13206525-8b8d-439f-89be-8fe3a12bb13d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Left_Motor_Control
		 (.oe(tmpOE__Left_Motor_Control_net),
		  .y({Net_149}),
		  .fb({tmpFB_0__Left_Motor_Control_net[0:0]}),
		  .io({tmpIO_0__Left_Motor_Control_net[0:0]}),
		  .siovref(tmpSIOVREF__Left_Motor_Control_net),
		  .interrupt({tmpINTERRUPT_0__Left_Motor_Control_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Left_Motor_Control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Right_Motor_Control_net;
	wire [0:0] tmpFB_0__Right_Motor_Control_net;
	wire [0:0] tmpIO_0__Right_Motor_Control_net;
	wire [0:0] tmpINTERRUPT_0__Right_Motor_Control_net;
	electrical [0:0] tmpSIOVREF__Right_Motor_Control_net;

	cy_psoc3_pins_v1_10
		#(.id("420798cd-ceb6-4984-8d0e-2785056258cb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Right_Motor_Control
		 (.oe(tmpOE__Right_Motor_Control_net),
		  .y({Net_150}),
		  .fb({tmpFB_0__Right_Motor_Control_net[0:0]}),
		  .io({tmpIO_0__Right_Motor_Control_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_Motor_Control_net),
		  .interrupt({tmpINTERRUPT_0__Right_Motor_Control_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_Motor_Control_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("49ca942a-133c-4923-b08e-bab88bc4711d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_1 Left_Motor_PWM (
        ...
        .ph1(Net_531),
        .ph2(Net_532));
    defparam Left_Motor_PWM.Resolution = 8;
